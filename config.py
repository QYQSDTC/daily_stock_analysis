...
class Config:
    ...
    # === 擒龙策略配置 ===
    dragon_hunt_enabled: bool = True  # 是否启用短线擒龙策略
    dragon_hunt_ai_enabled: bool = True  # 擒龙策略是否启用 AI 深度分析
    dragon_hunt_top_n: int = 5  # AI 分析前 N 只龙头股
    ...
    def _load_from_env(cls) -> "Config":
        ...
        return cls(
            ...
            dragon_hunt_enabled=os.getenv("DRAGON_HUNT_ENABLED", "true").lower() == "true",
            dragon_hunt_ai_enabled=os.getenv("DRAGON_HUNT_AI_ENABLED", "true").lower() == "true",
            dragon_hunt_top_n=int(os.getenv("DRAGON_HUNT_TOP_N", "5")),
